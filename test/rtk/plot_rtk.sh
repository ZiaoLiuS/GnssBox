...
file=results_zero/CUT2022001.out
...
awk '{if($1=="SSS") print $3, $6, $7, $8 }' $file > floatDX.txt
awk '{if($1=="OSS") print $3, $6, $7, $8 }' $file > DX.txt
awk '{if($1=="ISS") print $3, $6, $7, $8 }' $file > intDX.txt
...
set terminal png
set output "${file}.floatDX.png"

set terminal png size 2100,1300
set xlabel "Epoch (seconds)"
set ylabel "floatDX(m) "

set key top outside horizontal center

plot "floatDX.txt" using 1:2 with linespoints title "X", \
     "floatDX.txt" using 1:3 with linespoints title "Y", \
     "floatDX.txt" using 1:4 with linespoints title "Z"


set terminal png
set output "${file}.intDX.png"
...
plot "intDX.txt" using 1:2 with linespoints title "X", \
     "intDX.txt" using 1:3 with linespoints title "Y", \
     "intDX.txt" using 1:4 with linespoints title "Z"
