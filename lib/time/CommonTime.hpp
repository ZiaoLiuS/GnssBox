...
#ifndef COMMONTIME_HPP
#define COMMONTIME_HPP
   ...
   class CommonTime
   {
     public:
      ...
      static const double eps;
          ...
          * @see CommonTime::set()
          */
      explicit CommonTime(TimeSystem timeSystem = TimeSystem::GPS)
      ...
      CommonTime& set( double day,
                       TimeSystem timeSys = TimeSystem::GPS);
      ...
      void reset()
      { m_day = m_msod = 0; m_fsod = 0.0; m_timeSystem = TimeSystem::GPS; }
