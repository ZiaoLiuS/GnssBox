...
namespace utilSpace
{
   ...
   public:
      ...
      virtual double getValueAsDouble( std::string variable,
         ...
         noexcept(false)
      { 
         return asDouble( getValue(variable, section, 
                                                asString(defaultVal)) ); 
      };
      ...
      virtual int getValueAsInt( std::string variable,
         ...
         noexcept(false)
      { 
         return asInt( getValue(variable, section, 
                                    asString(defaultVal)) ); 
      };
      ...
      virtual double fetchListValueAsDouble( std::string variableList,
         ...
         noexcept(false)
      { 
         return asDouble( fetchListValue(variableList,section,
                                                      asString(defaultVal))); 
      };
      ...
      virtual int fetchListValueAsInt( std::string variableList,
         ...
         noexcept(false)
      { 
         return asInt( fetchListValue(variableList,section,
                                                   asString(defaultVal))); 
      };
      ...
      virtual int getNumItem( std::string variableList,
                              std::string section = "DEFAULT" )
         noexcept(false)
      { return numWords( getValue( variableList, section ) ); };
