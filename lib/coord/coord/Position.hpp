...
/**
 * @file Position.hpp
 * class coordSpace::Position encapsulates 3-D positions, including geographic positions,
...
namespace coordSpace
{
   ...
   double range(const Position& A, const Position& B) noexcept(false);
       ...
       *
       * Position will throw exceptions (coordSpace::GeometryException) on bad input
       ...
       * in coordSpace::CommonTime; this allows flexible and powerful I/O of Position to
       * strings and streams.
       *
   ...
   public:
         ...
         noexcept(false)
      {
         ...
         catch(GeometryException& ge) { RETHROW(ge); }
