...
#ifndef SP3EphStore_INCLUDE
#define SP3EphStore_INCLUDE
...
namespace gnssSpace
{
    ...
    class SP3EphStore : public XvtStore<SatID>
    {
    ...
    private:
        ...
        FileStore<SP3EphHeader> SP3Files;

         /// FileStore for the (optional) RINEX clock input files
        FileStore<Rx3ClockHeader> clkFiles;
    ...
    public:
         ...
         /// Default constructor
        SP3EphStore() throw() : storeTimeSystem(TimeSystem::Any),
                                      useSP3clock(true),
            ...
            const throw()
        {
            ...
            os << "End dump SP3EphStore." << std::endl;
        }
        ...
        { return posStore.ndata(sat); }
          ...
          * satellite system */
        inline int ndata(const SatelliteSystem::Systems& sys) const throw()
        ...
        { return posStore.ndata(sat); }
         ...
         /** Get the number of position data records for the given
          * satellite system */
        inline int ndataPosition(const SatelliteSystem::Systems& sys) const throw()
        { return posStore.ndata(sys); }
        ...
        { return clkStore.ndata(sat); }
          ...
          * satellite system */
        inline int ndataClock(const SatelliteSystem::Systems& sys) const throw()
                               ...
                               const PositionRecord& data) noexcept(false)
        {
            ...
            catch(InvalidRequest& ir) { RETHROW(ir); }
        }
