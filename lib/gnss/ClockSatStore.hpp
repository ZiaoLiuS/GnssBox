...
#ifndef CLOCK_SAT_STORE_INCLUDE
#define CLOCK_SAT_STORE_INCLUDE
...
namespace gnssSpace
{
   ...
   #ifdef SWIG
   %template(TabularSatStore_ClockRecord) gnssSpace::TabularSatStore<gnssSpace::ClockRecord>;
   #endif
