...
#ifndef POSITION_SAT_STORE_INCLUDE
#define POSITION_SAT_STORE_INCLUDE
...
namespace gnssSpace
{
   ...
   #ifdef SWIG
   %template(TabularSatStore_PositionRecord) gnssSpace::TabularSatStore<gnssSpace::PositionRecord>;
   #endif
...
#endif // POSITION_SAT_STORE_INCLUDE
