...
/// Encapsulates the GPS legacy broadcast ephemeris and clock.
...
namespace gnssSpace
{
    void GalEphemeris::printData() const
    {
        cout << "****************************************************************"
             << "************" << endl
        ...
        ///spare
        cout << "GALWeek: " << setw(16) << GALWeek << endl;
        ///spare
    ...
    double GalEphemeris::svRelativity(const CommonTime& t) const
    {
        ...
        return (REL_CONST_BDS * ecc * SQRT(A) * ::sin(Ek));
    }
