...
//
// modified from gpstk Rinex3EphemerisStore.hpp
//
// copyright
// 
// shoujian zhang
...
#ifndef Rx3NavStore_HPP
#define Rx3NavStore_HPP
...
namespace gnssSpace
{
   class Rx3NavStore : public XvtStore<SatID>
   {
   ...
   public:
      ...
      Rx3NavStore(const std::string& navFile )
      {
         rx3NavFile = navFile;
      };
